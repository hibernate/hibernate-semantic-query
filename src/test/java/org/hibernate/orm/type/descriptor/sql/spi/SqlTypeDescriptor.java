...
public interface SqlTypeDescriptor {
	 ...
	 */
	BasicJavaTypeDescriptor getJdbcRecommendedJavaTypeMapping(TypeConfiguration typeConfiguration);
	 ...
	 */
	<X> JdbcValueBinder<X> getBinder(JavaTypeDescriptor<X> javaTypeDescriptor);
	 ...
	 */
	<X> JdbcValueExtractor<X> getExtractor(JavaTypeDescriptor<X> javaTypeDescriptor);
}
