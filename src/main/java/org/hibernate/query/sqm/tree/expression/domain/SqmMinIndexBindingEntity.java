 ...
 */
public class SqmMinIndexBindingEntity extends AbstractSpecificSqmCollectionIndexBinding implements SqmMinIndexBinding,
		SqmEntityTypedBinding {
	private static final Logger log = Logger.getLogger( SqmMinIndexBindingEntity.class );

	private SqmFrom exportedFromElement;

	public SqmMinIndexBindingEntity(SqmPluralAttributeBinding pluralAttributeBinding) {
