 ...
 */
public class MaxIndexBindingEntity extends AbstractSingularIndexBinding implements MaxIndexBinding,
		SqmEntityTypedBinding {
	private static final Logger log = Logger.getLogger( MaxIndexBindingEntity.class );

	private SqmFrom exportedFromElement;

	public MaxIndexBindingEntity(SqmPluralAttributeBinding pluralAttributeBinding) {
