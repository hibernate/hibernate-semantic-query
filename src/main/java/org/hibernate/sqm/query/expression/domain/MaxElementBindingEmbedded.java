 ...
 */
public class MaxElementBindingEmbedded
		extends AbstractSingularElementBinding
		implements SqmRestrictedCollectionElementBindingEmbedded, MaxElementBinding {
	private static final Logger log = Logger.getLogger( MaxElementBindingEmbedded.class );

	private SqmFrom exportedFromElement;

	public MaxElementBindingEmbedded(SqmPluralAttributeBinding pluralAttributeBinding) {
