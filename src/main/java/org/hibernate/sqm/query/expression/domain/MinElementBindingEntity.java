 ...
 */
public class MinElementBindingEntity extends AbstractSingularElementBinding implements MinElementBinding,
		SqmEntityTypedBinding {
	private static final Logger log = Logger.getLogger( MinElementBindingEntity.class );

	private SqmFrom exportedFromElement;

	public MinElementBindingEntity(SqmPluralAttributeBinding pluralAttributeBinding) {
