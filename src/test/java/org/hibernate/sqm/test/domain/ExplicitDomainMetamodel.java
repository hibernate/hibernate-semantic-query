 ...
 */
public class ExplicitDomainMetamodel implements DomainMetamodel, PersisterCreationContext {
	...
	public ExplicitDomainMetamodel(MetadataImplementor mappingMetadata) {
...
//		}
	...
	public SqmNavigable resolveNavigable(SqmNavigableSource source, String navigableName) {
		...
		if ( navigable == null ) {
			throw new NoSuchAttributeException( "Could not locate attribute named [" + navigableName + " relative to [" + source.asLoggableText() + "]" );
		}
		return navigable;
	}
