 ...
 */
public abstract class StandardJdbcValueBinder<J> implements JdbcValueBinder<J> {
	private static final Logger log = CoreLogging.logger( StandardJdbcValueBinder.class );
	...
	public StandardJdbcValueBinder(JavaTypeDescriptor<J> javaDescriptor, SqlTypeDescriptor sqlDescriptor) {
