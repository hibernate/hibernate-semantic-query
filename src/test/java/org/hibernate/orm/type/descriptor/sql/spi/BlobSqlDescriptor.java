...
public abstract class BlobSqlDescriptor implements SqlTypeDescriptor {
	...
	protected abstract <X> StandardJdbcValueBinder<X> getBlobBinder(final JavaTypeDescriptor<X> javaTypeDescriptor);

	@Override
	public <X> StandardJdbcValueBinder<X> getBinder(final JavaTypeDescriptor<X> javaTypeDescriptor) {
	...
	public static final BlobSqlDescriptor DEFAULT = new BlobSqlDescriptor() {
		...
		public BasicJavaTypeDescriptor getJdbcRecommendedJavaTypeMapping(TypeConfiguration typeConfiguration) {
			return (BasicJavaTypeDescriptor) typeConfiguration.getJavaTypeDescriptorRegistry().getDescriptor( Blob.class );
		}

		@Override
		public <X> StandardJdbcValueBinder<X> getBlobBinder(final JavaTypeDescriptor<X> javaTypeDescriptor) {
	...
	public static final BlobSqlDescriptor PRIMITIVE_ARRAY_BINDING = new BlobSqlDescriptor() {
		@Override
		public BasicJavaTypeDescriptor getJdbcRecommendedJavaTypeMapping(TypeConfiguration typeConfiguration) {
			return (BasicJavaTypeDescriptor) typeConfiguration.getJavaTypeDescriptorRegistry().getDescriptor( byte[].class );
		}
