...
import org.hibernate.test.sqm.type.spi.IdentifierDescriptorMultipleAttribute;
 ...
 */
public class PseudoIdSqmAttributeImpl implements SingularSqmAttribute {
	private final IdentifiableType entityType;

	public PseudoIdSqmAttributeImpl(IdentifiableType entityType) {
	...
	public String asLoggableText() {
		return "ImplicitIdAttributeRef(" + getSource().getTypeName() + ".<pk>)";
	}
