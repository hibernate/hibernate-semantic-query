 ...
 */
public class CollectionIndexBindingEntity
		extends AbstractCollectionIndexBinding
		implements SqmNavigableSourceBinding, SqmEntityTypedBinding {
	private static final Logger log = Logger.getLogger( CollectionIndexBindingEntity.class );

	private SqmFrom exportedFromElement;

	public CollectionIndexBindingEntity(SqmPluralAttributeBinding pluralAttributeBinding) {
