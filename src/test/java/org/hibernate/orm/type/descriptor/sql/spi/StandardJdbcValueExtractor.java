 ...
 */
public abstract class StandardJdbcValueExtractor<J> implements JdbcValueExtractor<J> {
	private static final Logger log = CoreLogging.logger( StandardJdbcValueExtractor.class );

	private final JavaTypeDescriptor<J> javaDescriptor;
	private final SqlTypeDescriptor sqlDescriptor;

	public StandardJdbcValueExtractor(JavaTypeDescriptor<J> javaDescriptor, SqlTypeDescriptor sqlDescriptor) {
