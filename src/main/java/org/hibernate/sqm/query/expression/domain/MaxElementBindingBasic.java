 ...
 */
public class MaxElementBindingBasic
		extends AbstractSingularElementBinding
		implements SqmRestrictedCollectionElementBindingBasic, MaxElementBinding {
	public MaxElementBindingBasic(SqmPluralAttributeBinding pluralAttributeBinding) {
