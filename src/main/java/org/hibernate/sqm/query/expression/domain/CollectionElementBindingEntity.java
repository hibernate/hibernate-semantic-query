 ...
 */
public class CollectionElementBindingEntity extends AbstractCollectionElementBinding implements CollectionElementBinding,
		SqmEntityTypedBinding {
	private static final Logger log = Logger.getLogger( CollectionElementBindingEntity.class );

	private SqmFrom exportedFromElement;

	public CollectionElementBindingEntity(SqmPluralAttributeBinding pluralAttributeBinding) {
