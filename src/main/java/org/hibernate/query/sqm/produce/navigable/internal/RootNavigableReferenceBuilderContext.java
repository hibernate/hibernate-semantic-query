 ...
 */
public class RootNavigableReferenceBuilderContext extends AbstractNavigableReferenceBuilderContext {
	public RootNavigableReferenceBuilderContext(SemanticQueryBuilder semanticQueryBuilder) {
