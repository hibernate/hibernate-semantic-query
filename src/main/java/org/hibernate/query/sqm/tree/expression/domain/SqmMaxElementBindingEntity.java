 ...
 */
public class SqmMaxElementBindingEntity
		extends AbstractSpecificSqmElementBinding
		implements SqmRestrictedCollectionElementBindingEntity, SqmMaxElementBinding {
	private static final Logger log = Logger.getLogger( SqmMaxElementBindingEntity.class );

	private SqmFrom exportedFromElement;

	public SqmMaxElementBindingEntity(SqmPluralAttributeBinding pluralAttributeBinding) {
