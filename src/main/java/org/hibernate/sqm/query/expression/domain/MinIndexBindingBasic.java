 ...
 */
public class MinIndexBindingBasic extends AbstractSingularIndexBinding implements MinIndexBinding {
	public MinIndexBindingBasic(SqmPluralAttributeBinding attributeBinding) {
